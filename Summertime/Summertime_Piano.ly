...
% SummertimeSolo=\new Voice \relative c''{
% << {\new CueVoice {\stemUp
% \partial 4 \tuplet 3/2{ais8^\markup{piano} (b d)}
% f4 f8 (d f) d4 f8--
% fis!8 (d a ais b4 \tuplet 3/2{d8 dis e}
% fis8)\noBeam \stemDown f,8 e4 d cis 
% b4 a g8 fis~fis4}}
% {r4
% r1 
% r1
% r1
% r2 \acciaccatura g''8 fis4^\markup{Solo} (d)} >> \bar"||"
% fis1
% ~fis8 r8 fis(d e fis d4) 
% b2 (fis2
% ~fis4) r fis' (d) 
% e4. e8 ~e2 
% r4 d8 \mp \<(b d b d4)\! 
...
% fis8-- e4. d2
% \acciaccatura d8 b1 
% ~b8_\markup{Improv.} r^\markup{break} r4 r2\bar"||"
% \cadenzaOn 
% \stopStaff 
...
% }
% {
% \new CueVoice {\stemDown b,4 (e8 d e fis d b) 
% fis4 r d'2 
% c2 a 
% b4 cis8 (b cis d ais4) \stemUp
% b'4 (gis a ais 
% b2.\fermata r4}
% }
% >>
